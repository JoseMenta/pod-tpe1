...
./counterClient.sh -DserverAddress=localhost:50051 -Daction=assignCounters -Dsector=C -Dflights=AC987'|'AD987 -Dairline=AirCanada -DcounterCount=20
./counterClient.sh -DserverAddress=localhost:50051 -Daction=assignCounters -Dsector=C -Dflights=AE987 -Dairline=AirCanada -DcounterCount=2
