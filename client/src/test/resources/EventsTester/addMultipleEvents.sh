...
./eventsClient.sh -DserverAddress=localhost:50051 -Daction=register -Dairline=AmericanAirlines & event1=$!
./eventsClient.sh -DserverAddress=localhost:50051 -Daction=register -Dairline=AmericanAirlines & event2=$!
