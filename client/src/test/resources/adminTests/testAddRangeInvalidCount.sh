...
./adminClient.sh -DserverAddress=localhost:50051 -Daction=addCounters -Dsector=D -Dcounters=0
./adminClient.sh -DserverAddress=localhost:50051 -Daction=addCounters -Dsector=D -Dcounters=-1
